...
def create_frame():
    PATH_TO_REPO = "/home/agentolek/AI"
    sequence_path = PATH_TO_REPO + "/Bootcamp-mini-hackathon-2024/dane/zadanie_2/znaki-sekwencje-20160604.csv"
    sequence_dict = read_seqs(sequence_path)
    scenes_path = PATH_TO_REPO + "/Bootcamp-mini-hackathon-2024/dane/zadanie_2/obiekty-sceny-20160604.csv"
    object_scenes = read_scenes(scenes_path)

    object_sequences_path = PATH_TO_REPO + "/Bootcamp-mini-hackathon-2024/dane/zadanie_2/obiekty-sekwencje-20160604.csv"
